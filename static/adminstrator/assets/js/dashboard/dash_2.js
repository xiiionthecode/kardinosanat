  ...
  Apex.tooltip = {
    ...
    */
    ...
    var spark1 = {
        ...
        series: [{
            data: [17, 9, 12, 24, 44, 25, 59, 41, 66, 25].reverse()
        }],
        stroke: {
          curve: 'smooth',
          width: 2,
    ...
    var spark2 = {
        ...
        series: [{
          data: [17, 9, 12, 24, 34, 25, 47, 41, 66, 25].reverse()
        }],
        stroke: {
          curve: 'smooth',
          width: 2,
    ...
    */
    ...
    var d_1options1 = {
      ...
      series: [{
          name: 'بیش از ۵ دقیقه',
          data: [0, 0, 0, 0, 0, 0, 0, 0, 0, 48, 56, 0].reverse()
      }, {
          name: 'کمتر از ۵ دقیقه',
          data: [0, 0, 0, 0, 0, 0, 0, 0, 0, 10, 66, 0].reverse()
      }],
      xaxis: {
